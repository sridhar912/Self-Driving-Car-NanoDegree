...
This repository contains the code needed to localize the robot using Particle Filtering. This project is a part of the course in Udacity's Self-Driving Car Nanodegree. The dataflow of this project is shown in the following diagram.
![DataFlow](images/localization.png)
