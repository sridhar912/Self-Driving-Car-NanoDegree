...
RADAR and LIDAR Fusion using Extended Kalman Filter in C++. This project utilizes the pedestrian location information obtained using both RADAR and LIDAR pre-processed data and fuses it using Extended Kalman Filter. The dataflow of this project is shown in the following diagram.
